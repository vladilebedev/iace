...
function consulting_thinkup_customizer_theme_options( $wp_customize ) {
	...
	$wp_customize->add_section(
		new consulting_thinkup_customizer_customswitch_button_link(
			...
			array(
				...
				'button_url'  => '//www.thinkupthemes.com/themes/consulting/',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'description'	  => __( 'Check to enable floating header.<br /><strong>Note:</strong> Only works with full-width slider.', 'consulting' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new consulting_thinkup_customizer_customcontrol_upgrade_inner(
			...
			array(
				...
				'upgrade_url'     => '//www.thinkupthemes.com/themes/consulting/',
